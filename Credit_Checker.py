...
# We make an if loop here to check if the credit card number is legitemate before we apply Luhn's to check if it is valid.
if cardNo[0] != '4' and cardNo[0] != '5' and cardNo[0] != '6' and cardNo[0:2] != "37":
